...
ofstream f1_1, f1_2, f2, f3, f4_1, f4_2, f5, f6, f6_1, f7, f9, f9_2, f6_2, ftest, X, Y, f1, f4, shake, f8, velseg, GyroAngle, allign, unalligned, ei;
	...
	{   
		...
		for (int i = 0; i < 20000; i++)
		{
			...
			{	
				...
				SpinScanGyroAlligned2(GyroData, 0);
				//if (cadence_acc == 0)
				//	SpinScan(rawData, 2);
				ii++;
			}
